...
export function HomePage() {
  ...
  const gradientMotionProps = reducedMotion
    ? {}
    : {
        animate: { backgroundPosition: ["0% 0%", "100% 100%", "0% 0%"] },
        transition: { duration: 16, ease: "easeInOut", repeat: Infinity },
      };
  const heroContainerMotionProps = reducedMotion
    ? {}
    : {
        animate: "visible",
        initial: "hidden",
  ...
  const heroItemMotionProps = reducedMotion
    ? {}
    : {
        transition: { duration: 0.5, ease: "easeOut" },
        variants: heroVariants,
      };
  const heroEyebrowMotionProps = reducedMotion
    ? {}
    : {
        transition: { duration: 0.45, ease: "easeOut" },
        variants: heroVariants,
      };
  const portraitMotionProps = reducedMotion
    ? {}
    : {
        animate: { y: [0, -8, 0] },
    ...
    <main aria-label="Home" id="main-content">
      <section className="relative overflow-hidden bg-[var(--gradient-hero)]">
        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-8.5rem)] max-w-6xl items-center gap-12 px-4 py-20 md:grid-cols-[1.2fr_0.8fr]">
          <motion.div className="max-w-3xl" {...heroContainerMotionProps}>
            <motion.p className="font-mono text-sm text-primary" {...heroEyebrowMotionProps}>
            ...
            <motion.div className="mt-8" {...heroItemMotionProps}>
              <a
          ...
          <motion.div className="relative mx-auto w-full max-w-sm" {...portraitMotionProps}>
            <div
              aria-hidden
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          {projects
            ...
            .map((project, index) => {
              const projectMotionProps = reducedMotion
                ? {}
                : {
              ...
              return (
                <motion.div key={project.slug} {...projectMotionProps}>
